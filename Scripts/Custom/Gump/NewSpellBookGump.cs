...
namespace Server.Gumps
{
    ...
    public class NewSpellbookGump : Gump
    {
        public static SpellBookEntry[] m_SpellBookEntry = new SpellBookEntry[]
        {
			...
			new SpellBookEntry( 6, MagieType.Anarchique,"Mal??#$?&*diction", new Type[] {typeof(Nightshade), typeof(Garlic), typeof(SulfurousAsh) },0x8da, 4,756),
			...
			new SpellBookEntry( 9, MagieType.Anarchique,"Invisibilit??#$?&*", new Type[] {typeof(Bloodmoss), typeof(Nightshade) },0x8eb, 6,759),
			...
			new SpellBookEntry( 13, MagieType.Anarchique,"Voyage ??#$?&*th??#$?&*r??#$?&*", new Type[] { },23012, 2,751),
			...
			new SpellBookEntry( 0, MagieType.Arcane,"Armure r??#$?&*active", new Type[] {typeof(Garlic), typeof(SpidersSilk), typeof(SulfurousAsh) },0x8c6, 1,766),
			...
			new SpellBookEntry( 0, MagieType.Arcane,"Gu??#$?&*rison", new Type[] {typeof(Garlic), typeof(Ginseng), typeof(SpidersSilk) },0x8c3, 1,769),
			...
			new SpellBookEntry( 0, MagieType.Arcane,"Agilit??#$?&*", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot) },0x8C8, 2,774),
			...
			new SpellBookEntry( 0, MagieType.Arcane,"T??#$?&*l??#$?&*kin??#$?&*sie", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot) },0x8d4, 3,784),
			new SpellBookEntry( 0, MagieType.Arcane,"T??#$?&*l??#$?&*portation", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot) },0x8d5, 3,785),
			...
			new SpellBookEntry( 0, MagieType.Arcane,"??#$?&*l??#$?&*m. : Feu", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot), typeof(SpidersSilk)},0x8fe, 8,789),
			new SpellBookEntry( 0, MagieType.Arcane,"??#$?&*l??#$?&*m. : Terre", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot), typeof(SpidersSilk) },0x8fd, 8,790),
			new SpellBookEntry( 0, MagieType.Arcane,"??#$?&*l??#$?&*m. : Air", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot), typeof(SpidersSilk) },0x8fb, 8,791),
			new SpellBookEntry( 16, MagieType.Arcane,"??#$?&*l??#$?&*m. : Eau", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot), typeof(SpidersSilk) },0x8ff, 8,840),
			...
			new SpellBookEntry( 4, MagieType.Cycle,"Cr??#$?&*atures", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot), typeof(SpidersSilk) },0x8e7, 5,801),		
			new SpellBookEntry( 5, MagieType.Cycle,"Fl??#$?&*trissement", new Type[] {typeof(NoxCrystal), typeof(GraveDust), typeof(PigIron) },20494, 6,797),
			...
			new SpellBookEntry( 8, MagieType.Cycle,"R??#$?&*animation", new Type[] {typeof(GraveDust), typeof(DaemonBlood) },20480, 4,800),
			...
			new SpellBookEntry( 14, MagieType.Cycle,"Cyclone du N??#$?&*ant", new Type[] {typeof(MandrakeRoot), typeof(Nightshade), typeof(SulfurousAsh) },24014, 8,805),
			...
			new SpellBookEntry( 16, MagieType.Cycle,"S??#$?&*isme", new Type[] {typeof(Bloodmoss), typeof(Ginseng), typeof(MandrakeRoot) },2296, 8,807),
			
			new SpellBookEntry( 1, MagieType.Mort,"Calamite", new Type[] {typeof(PigIron) },0x5003, 1,809),
			new SpellBookEntry( 2, MagieType.Mort,"Mauvais pr??#$?&*sage", new Type[] {typeof(BatWing), typeof(NoxCrystal) },20484, 2,810),
			...
			new SpellBookEntry( 5, MagieType.Mort,"Arme Anim??#$?&*e", new Type[] {typeof(BlackPearl), typeof(MandrakeRoot), typeof(Nightshade) },24006, 4,812),
			...
			new SpellBookEntry( 7, MagieType.Mort,"Mal??#$?&*diction de gr.", new Type[] {typeof(Garlic), typeof(Nightshade), typeof(MandrakeRoot) },2285, 6,814),
			...
			new SpellBookEntry( 13, MagieType.Mort,"??#$?&*tranglement", new Type[] {typeof(DaemonBlood), typeof(NoxCrystal) },0x8e5, 6,820),
			...
			new SpellBookEntry( 16, MagieType.Mort,"D??#$?&*mon", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot), typeof(SpidersSilk) },0x8fc, 8,823),
			...
			new SpellBookEntry( 5, MagieType.Obeissance,"??#$?&*clair", new Type[] {typeof(MandrakeRoot), typeof(SulfurousAsh) },0x8dd, 4,828),
			...
			new SpellBookEntry( 14, MagieType.Obeissance,"??#$?&*vasion", new Type[] { },21538, 6,837),
			...
			new SpellBookEntry( 16, MagieType.Obeissance,"R??#$?&*surrection", new Type[] {typeof(Bloodmoss), typeof(Garlic), typeof(Ginseng) },0x8fa, 8,839),
		
			new SpellBookEntry( 1, MagieType.Vie,"R??#$?&*v??#$?&*lation", new Type[] {typeof(Bloodmoss), typeof(SulfurousAsh) },0x8ef, 6,843),
			...
			new SpellBookEntry( 4, MagieType.Vie,"B??#$?&*n??#$?&*diction", new Type[] {typeof(Garlic), typeof(MandrakeRoot) },0x8da, 3,845),
			...
			new SpellBookEntry( 7, MagieType.Vie,"Gu??#$?&*rison majeure", new Type[] {typeof(Garlic), typeof(Ginseng), typeof(MandrakeRoot) },0x8dc, 4,848),
			new SpellBookEntry( 8, MagieType.Vie,"Paralysie", new Type[] {typeof(Garlic), typeof(MandrakeRoot), typeof(SpidersSilk) },0x8E5, 5,849),
			new SpellBookEntry( 9, MagieType.Vie,"Lumière sacr??#$?&*e", new Type[] { },20742, 5,850),
			...
			new SpellBookEntry( 14, MagieType.Vie,"Boule d'??#$?&*nergie", new Type[] { },0x8e9, 6,854),
        ...
        public void InitializeHashtable()
        {
			...
			m_Names[MagieType.Obeissance] = "Ob??#$?&*issance";
        ...
        public NewSpellbookGump(Mobile from, NewSpellbook book) : base(150, 200)
        {
			...
			for (int i = 0; i < m_SpellBookEntry.Length; i++)
			{
				...
				//on fait la comparaison des Aptitude pour savoir si on a chang??#$?&* de connaissance
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            if (from is CustomPlayerMobile)
            {
                ...
                else if (info.ButtonID >= 1000 && info.ButtonID < 2000)
                {
                    ...
                    {
                        m.SendMessage("Le sort a ??#$?&*t??#$?&* ajout??#$?&* à votre liste de lancement rapide.");
