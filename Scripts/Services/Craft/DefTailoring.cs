...
namespace Server.Engines.Craft
{
    ...
    public class DefTailoring : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
			...
			index = AddCraft(typeof(Bottes), 1015288,  1015288, 45.7,65.7, typeof(Leather), 1044462, 15, 1044463);
			index = AddCraft(typeof(Bottes2), 1015288,  "Bottes2", 71.8,91.8, typeof(Leather), 1044462, 15, 1044463);
			index = AddCraft(typeof(Bottes3), 1015288,  "Bottes3", 75.7,95.7, typeof(Leather), 1044462, 15, 1044463);
			index = AddCraft(typeof(Bottes4), 1015288,  "Bottes4", 57.6,77.6, typeof(Leather), 1044462, 15, 1044463);
			index = AddCraft(typeof(Bottes5), 1015288,  "Bottes5", 52.0,72.0, typeof(Leather), 1044462, 15, 1044463);
			index = AddCraft(typeof(Bottes6), 1015288,  "Bottes6", 85.6,105.6, typeof(Leather), 1044462, 15, 1044463);
			index = AddCraft(typeof(Bottes7), 1015288,  "Bottes7", 74.1,94.1, typeof(Leather), 1044462, 15, 1044463);
