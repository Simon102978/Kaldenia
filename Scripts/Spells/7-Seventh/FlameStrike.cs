...
namespace Server.Spells.Seventh
{
    public class FlameStrikeSpell : MagerySpell
    {
		...
		public override MagicAptitudeRequirement[] AffinityRequirements { get { return new MagicAptitudeRequirement[] { new MagicAptitudeRequirement(MagieType.Anarchique, 14) }; } }
