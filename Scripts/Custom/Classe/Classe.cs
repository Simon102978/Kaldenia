				...
				public static void Configure()
					{
						Classe.RegisterClasse(new Classe(-1, "Aucune",ClasseType.None,new List<SkillName>() {  },0));
			     		...
			     		Classe.RegisterClasse(new Classe(0,	"??#$?&*p??#$?&*iste",ClasseType.Guerrier,new List<SkillName>() { SkillName.Swords,SkillName.Tactics,SkillName.Focus },3));
						...
						Classe.RegisterClasse(new Classe(7,  "M??#$?&*n??#$?&*strel", ClasseType.Roublard, new List<SkillName>() { SkillName.Musicianship, SkillName.Peacemaking, SkillName.Provocation,SkillName.Discordance }, 2));
						...
						Classe.RegisterClasse(new Classe(13, "Ing??#$?&*nieur", ClasseType.Metier, new List<SkillName>() { SkillName.Blacksmith, SkillName.Tinkering }, 0));
						...
						Classe.RegisterClasse(new Classe(16, "??#$?&*picier", ClasseType.Metier, new List<SkillName>() { SkillName.Cooking, SkillName.Alchemy }, 0));
					}
		}
}
