...
{
    public abstract class ContainerFood : BaseFood
    {
        ...
        //public Mobile Poisoner1 { get => m_Poisoner; set => m_Poisoner = value; }

        public Mobile Poisoner1
        {
            get { return m_Poisoner; }
            set { m_Poisoner = value; InvalidateProperties(); }
        }
        public Poison Poison1
        {
            get { return m_Poison; }
            set { m_Poison = value; InvalidateProperties(); }
        }
        //public Poison Poison1 { get => m_Poison; set => m_Poison = value; }
