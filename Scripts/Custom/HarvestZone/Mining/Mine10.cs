...
{
    public class Mine10 : HarvestZone
    {
        public static void Initialize()
        {
            HarvestZone.AddZone(new Mine10());
        }
            ...
            : base(ZoneType.Mining)
        {
            ...
            //            Map = Map.Trammel;
                          ...
                          Area.Add(new Rectangle3D(new Point3D(4049, 1966, 0), new Point3D(4100, 1984, 0)));
						  Area.Add(new Rectangle3D(new Point3D(4009, 1969, 0), new Point3D(4041, 1986, 0)));
			...
			Veins = new HarvestVein[]
				...
				//	new HarvestVein( 50.0, 0.0, Resources[4], Resources[0]), // BronzeOre - 80
					new HarvestVein( 50.0, 0.0, Resources[5], Resources[0]), // GoldOre - 85
