...
namespace Server.Gumps
{
    public class CustomDyeGump : BaseProjectMGump
	{
		...
		public static Dictionary<int, CouleurSet> ColorIndex = new Dictionary<int, CouleurSet>()
		{
			 ...
			 { 7, new CouleurSet("Hue color??#$?&*", 2101,   new List<int>(){2101, 2102, 2103, 2104, 2105, 2106, 2107, 2108, 2109, 2110, 2111, 2112, 2113, 2114, 2115, 2116, 2117, 2118} )}
			...
			: base("Couleurs", 560, 360, false)
		{
			...
			AddSection(x - 10, y, 300, 349, "Cat??#$?&*gories");
		...
		public override void OnResponse(NetState sender, RelayInfo info)
        {
			...
			if (info.ButtonID == 1)
			{
				...
				m_From.SendMessage("Vous m??#$?&*langez les couleurs.");
