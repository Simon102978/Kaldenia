...
namespace Server.Items
{
    ...
    public class SeedBoxExp : BaseContainer
    {
...
//			return;
            ...
            if ( !from.InRange( GetWorldLocation(), 2 ) )
                ...
                from.SendGump( new SeedBoxGumpExp( ( PlayerMobile ) from, this ) );
        }

        public SeedBoxExp( Serial serial ) : base( serial )
		{
		}
