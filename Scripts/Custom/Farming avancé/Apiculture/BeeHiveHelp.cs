	...
	public class apiBeeHiveHelpGump : Gump
	{
		...
		public string HelpText(int type)
		{
			...
			switch( type )
			{
                ...
                text += "<p>Comme n'importe quelle chose vivante, les abeilles peuvent être attaquées par des forces extérieures. De parasites à maladie, l'apiculturiste possède une multitude d'outils à sa disposition pour contrer cela.</p>";
