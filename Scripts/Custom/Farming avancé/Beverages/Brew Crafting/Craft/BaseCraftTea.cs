...
{
	public abstract class BaseCraftTea : Item, ICraftable
	{
		...
		public BaseCraftTea( Serial serial ) : base( serial ) { }
		...
		public BaseCraftTea( int itemID ) :  base( itemID )
		{
