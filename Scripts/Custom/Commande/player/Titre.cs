            ...
            if (pm != null)
            {
                ...
                switch (pm.TitleCycle)
                {
                    case 0:
                        {
                            pm.Title = primaire;
                            pm.SendMessage("Vous affichez d??#$?&*sormais le titre de classe: {0}", primaire );
                            break;
                        }
                    case 1:
                        {
                            pm.Title = secondaire;
                            pm.SendMessage("Vous affichez d??#$?&*sormais le titre de classe: {0}", secondaire);
                            break;
                        }
                    case 2:
                        {
                            pm.Title = metier;
                            pm.SendMessage("Vous affichez d??#$?&*sormais le titre de m??#$?&*tier: {0}", metier);
                            break;
						}
					case 3:
					{
							pm.Title = pm.StatutSocialString();
							pm.SendMessage("Vous affichez d??#$?&*sormais le titre de statut social : {0}", pm.StatutSocialString());
							break;
					}
					case 4:
                        {
                            pm.Title = customTitle;
                            pm.SendMessage("Vous affichez d??#$?&*sormais le titre personnalis??#$?&*: {0}", customTitle);
                            break;
                        }
                    case 5:
                        {
                            pm.Title = DegTitle;
                            pm.SendMessage("Vous affichez d??#$?&*sormais le titre de votre d??#$?&*guisement: {0}", DegTitle);
                            break;
                        }
					...
					case 6:
						{
							pm.Title = "";
							pm.SendMessage("Vous affichez d??#$?&*sormais aucun titre.");
							break;
						}
						...
						/*       case 5:
								   {
									   ...
									   pm.SendMessage("Vous affichez d??#$?&*sormais le titre de guilde: {0}", titreGuilde);
									   break;
								   }*/
				}
            }
