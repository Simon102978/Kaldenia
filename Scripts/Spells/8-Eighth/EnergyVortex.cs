...
namespace Server.Spells.Eighth
{
    public class EnergyVortexSpell : MagerySpell
    {
		...
		public override MagicAptitudeRequirement[] AffinityRequirements { get { return new MagicAptitudeRequirement[] { new MagicAptitudeRequirement(MagieType.Anarchique, 16) }; } }
