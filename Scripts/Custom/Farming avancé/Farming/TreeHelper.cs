...
namespace Server.Items.Crops
{
	...
	{
		public static bool CanPickMounted{ get{ return Config.Get("Farming.CanPickMounted", true); } }
        public static bool TreeOrdinance{ get{ return Config.Get("Farming.CanPickMounted", false); } }

		//public static TimeSpan SaplingTime = TimeSpan.FromMinutes( 60 );
        public static TimeSpan SaplingTime = TimeSpan.FromMinutes(Config.Get("Farming.SaplingTime", 60));
        //public static TimeSpan StumpTime = TimeSpan.FromMinutes( 60 );
        public static TimeSpan StumpTime = TimeSpan.FromMinutes(Config.Get("Farming.StumpTime", 60));
