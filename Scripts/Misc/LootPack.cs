        ...
        public static readonly LootPack LootMeager =
            new LootPack(
                new[]
                {
					...
					new LootPackEntry(false, false, Gold25, 50.0, 1, true),
					new LootPackEntry(false, false, Gold50, 20.0, 1, true),
        ...
        public static readonly LootPack LootAverage =
            new LootPack(
                new[]
                {
					...
					new LootPackEntry(false, false, Gold100, 50.0, 1, true),
        ...
        public static readonly LootPack LootRich =
            new LootPack(
                new[]
                {
					...
					new LootPackEntry(false, false, Gold50, 75.0, 1, true),
					new LootPackEntry(false, false, Gold75, 75.0, 1, true),
					new LootPackEntry(false, false, Gold100, 10.0, 1, true),
					new LootPackEntry(false, false, Gold150, 50.0, 1, true),
					new LootPackEntry(false, false, Gold200, 20.0, 0, true),
					new LootPackEntry(false, false, Gold250, 10.0, 0, true),
      ...
      //              new LootPackEntry(false, false, MagicItemsRichType2, 61.70, 1, 5, 0, 100, true),
        ...
        public static readonly LootPack LootFilthyRich =
            new LootPack(
                ...
                {
						new LootPackEntry(false, false, Gold5, 100.0, 5, true),
					new LootPackEntry(false, false, Gold10, 100.0, 3, true),
					new LootPackEntry(false, false, Gold25, 100.0, 2, true),
					new LootPackEntry(false, false, Gold25, 75.0, 2, true),
        ...
        public static readonly LootPack LootUltraRich =
            new LootPack(
                new[]
                {
						new LootPackEntry(false, false, Gold5, 100.0, 15, true),
					new LootPackEntry(false, false, Gold10, 100.0, 15, true),
					new LootPackEntry(false, false, Gold25, 100.0, 10, true),
					new LootPackEntry(false, false, Gold25, 100.0, 10, true),
					new LootPackEntry(false, false, Gold50, 75.0, 5, true),
					new LootPackEntry(false, false, Gold75, 75.0, 5, true),
					new LootPackEntry(false, false, Gold100, 100.0, 3, true),
					new LootPackEntry(false, false, Gold150, 100.0, 3, true),
      ...
      //              new LootPackEntry(false, false, MagicItemsUltraRich, 100.00, 1, 5, 25, 100, true),
        ...
        public static readonly LootPack LootSuperBoss =
            new LootPack(
                new[]
                {
					new LootPackEntry(false, false, Gold5, 100.0, 30, true),
					new LootPackEntry(false, false, Gold10, 100.0, 20, true),
					new LootPackEntry(false, false, Gold25, 100.0, 20, true),
					new LootPackEntry(false, false, Gold25, 100.0, 5, true),
					new LootPackEntry(false, false, Gold50, 100.0, 5, true),
					new LootPackEntry(false, false, Gold75, 100.0, 5, true),
					new LootPackEntry(false, false, Gold100, 100.0, 5, true),
					new LootPackEntry(false, false, Gold150, 100.0, 5, true),
					new LootPackEntry(false, false, Gold200, 100.0, 5, true),
					new LootPackEntry(false, false, Gold250, 100.0, 5, true),
