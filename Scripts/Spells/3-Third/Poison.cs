...
namespace Server.Spells.Third
{
    public class PoisonSpell : MagerySpell
    {
		...
		public override MagicAptitudeRequirement[] AffinityRequirements { get { return new MagicAptitudeRequirement[] { new MagicAptitudeRequirement(MagieType.Anarchique, 7) }; } }
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckHSequence(m))
            {
                ...
                else
                {
                    ...
                    int total = (Caster.Skills.Magery.Fixed + Caster.Skills.EvalInt.Fixed) / 2;
