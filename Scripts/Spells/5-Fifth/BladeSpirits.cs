...
namespace Server.Spells.Fifth
{
    public class BladeSpiritsSpell : MagerySpell
    {
		...
		public override MagicAptitudeRequirement[] AffinityRequirements { get { return new MagicAptitudeRequirement[] { new MagicAptitudeRequirement(MagieType.Obeissance, 4) }; } }
