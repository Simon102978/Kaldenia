...
namespace Server.Spells.Sixth
{
    public class RevealSpell : MagerySpell
    {
		...
		public override MagicAptitudeRequirement[] AffinityRequirements { get { return new MagicAptitudeRequirement[] { new MagicAptitudeRequirement(MagieType.Vie, 1) }; } }
        ...
        private static bool CheckDifficulty(Mobile from, Mobile m)
        {
            ...
            int detectHidden = from.Skills[SkillName.EvalInt].Fixed;

            int hiding = m.Skills[SkillName.Hiding].Fixed;
         //   int stealth = m.Skills[SkillName.Stealth].Fixed;
            int divisor = hiding * 2 /*+ stealth*/;
