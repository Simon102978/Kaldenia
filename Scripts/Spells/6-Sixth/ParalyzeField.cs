...
namespace Server.Spells.Sixth
{
    public class ParalyzeFieldSpell : MagerySpell
    {
		...
		public override MagicAptitudeRequirement[] AffinityRequirements { get { return new MagicAptitudeRequirement[] { new MagicAptitudeRequirement(MagieType.Obeissance, 12) }; } }
