	...
	public class apiBeeHiveHelpGump : Gump
	{
		...
		public string HelpText(int type)
		{
			...
			switch( type )
			{
                ...
                text += "<p><b>Couvée</b> - les oeufs pondues débutent en pleine force comme la ruche se prépare à commencer la production d'envergure.</p>";
                ...
                text += "<p><b>Prospèration</b> - les abeilles sont en excellente santé. Une colonie prospère produira le miel et la cire en plus grosse quantité.</p>";
                text += "<p><b>Sain</b> - les abeilles sont en santé et produises le miel et la cire.</p>";
                text += "<p><b>Malade</b> - les abeilles sont maladives, elles ne produises plus de miel et de cire.</p>";
                text += "<p><b>Mourrante</b> - si quelque chose ne se fait pas rapidement, la population de la ruche va commencer à diminuer.</p>";
                ...
                text += "<p>Comme n'importe quelle chose vivante, les abeilles peuvent être attaquées par des forces extérieures. De parasites à maladie, l'apiculturiste possède une multitude d'outils à sa disposition pour contrer cela.</p>";s
                ...
                text += "<p><b>Production</b> - ce bouton t'emmene au <b>gump de production</b>, oû le gardien de la ruche peut récolter les ressources qu'ont produit les abeilles.</p>";
                text += "<p><b>Infestation</b> - un trait d'union jaune ou rouge signifie que la ruche est infestée par des parasites ou d'autres insectes. Utilise du <b>poison</b> pour tuer la menace.</p>";
                ...
                text += "<p><b>Fleurs</b> - cette icône indique la somme de fleurs disponibles à la ruche. Les abeilles utilisent les fleurs et leurs sous-produits pour presque chaqu'une des fonctions de la ruche, la construction et la nourriture étant inclu. Possèder trop de fleurs peut mettre en contact les abeilles avec les parasites ou les insectes.</p>";
                ...
                text +="<p>Cette cire à l'état brut peut être placer à l'intérieur d'un <b>petit pot de cire</b>. Une fois appliqué dans une source de chaleur, la cire fond pour permettre à l'apiculturiste de retirer les impuretés, aussi connu en tant que <b>slumgum</b>.</p>";
