	...
	public class DefBowFletching : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			*/
			...
			// Munitions
			AddCraft(typeof(Kindling), "Munitions", "Petit bois", 0.0, 00.0, typeof(Board), 1044041, 1, 1044351);
			AddCraft(typeof(Shaft), "Munitions", "Fût", 0.0, 40.0, typeof(Board), 1044041, 1, 1044351);
			SetUseAllRes(index, true);
			AddCraft(typeof(Arrow), "Munitions", "Flèche", 0.0, 40.0, typeof(Shaft), 1044560, 1, 1044561);
			AddRes(index, typeof(Feather), 1044562, 1, 1044563);
			SetUseAllRes(index, true);
			AddCraft(typeof(Bolt), "Munitions", "Carraux", 0.0, 40.0, typeof(Shaft), 1044560, 1, 1044561);
			AddRes(index, typeof(Feather), 1044562, 1, 1044563);
			SetUseAllRes(index, true);
			...
			*/
			// Arcs
			AddCraft(typeof(Bow), "Arcs", "Arc simple", 30.0, 70.0, typeof(Board), 1044041, 7, 1044351);
			AddCraft(typeof(Legarc), "Arcs", "Legarc", 60.0, 90.0, typeof(Board), 1044041, 7, 1044351);
			AddCraft(typeof(Tarkarc), "Arcs", "Arc court renforcit", 60.0, 90.0, typeof(Board), 1044041, 7, 1044351);
			AddCraft(typeof(Souplecorde), "Arcs", "Souplecorde", 60.0, 90.0, typeof(Board), 1044041, 7, 1044351);
			AddCraft(typeof(Sombrevent), "Arcs", "Sombrevent", 60.0, 90.0, typeof(Board), 1044041, 7, 1044351);
			AddCraft(typeof(CompositeBow), "Arcs", "Arc composite", 60.0, 90.0, typeof(Board), 1044041, 7, 1044351);
			AddCraft(typeof(Yumi), "Arcs", "Arc long", 60.0, 90.0, typeof(Board), 1044041, 10, 1044351);
			AddCraft(typeof(ElvenCompositeLongbow), "Arcs", "Arc long composite", 60.0, 90.0, typeof(Board), 1044041, 20, 1044351);
			AddCraft(typeof(MagicalShortbow), "Arcs", "Percecoeur", 60.0, 90.0, typeof(Board), 1044041, 15, 1044351);

			// Arbalètes
			AddCraft(typeof(Crossbow), "Arbalètes", "Arbalète simple", 30.0, 70.0, typeof(Board), 1044041, 7, 1044351);
			AddCraft(typeof(HeavyCrossbow), "Arbalètes", "Arbalète lourd", 60.0, 90.0, typeof(Board), 1044041, 10, 1044351);
			AddCraft(typeof(Percemurs), "Arbalètes", "Percemurs", 60.0, 90.0, typeof(Board), 1044041, 7, 1044351);
			AddCraft(typeof(Arbavive), "Arbalètes", "Arbavive", 60.0, 90.0, typeof(Board), 1044041, 7, 1044351);
			AddCraft(typeof(Lumitrait), "Arbalètes", "Lumitrait", 60.0, 90.0, typeof(Board), 1044041, 10, 1044351);
			AddCraft(typeof(ArbaletteChasse), "Arbalètes", "Arbaletes de chasse", 60.0, 90.0, typeof(Board), 1044041, 10, 1044351);
			AddCraft(typeof(RepeatingCrossbow), "Arbalètes", "Arbalète à répétition", 60.0, 90.0, typeof(Board), 1044041, 10, 1044351);
