...
{
    public class Mine6 : HarvestZone
    {
        public static void Initialize()
        {
            HarvestZone.AddZone(new Mine6());
        }
            ...
            : base(ZoneType.Mining)
        {
            ...
            //            Map = Map.Trammel;
                          ...
                          Area.Add(new Rectangle3D(new Point3D(1682, 359, 0), new Point3D(1707, 371, 0)));
            ...
            Veins = new HarvestVein[]
                {
					new HarvestVein( 30.0, 0.0, Resources[0], null ), // Iron
