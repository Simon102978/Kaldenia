...
namespace Server.Spells.Fourth
{
    public class GreaterHealSpell : MagerySpell
    {
		...
		public override MagicAptitudeRequirement[] AffinityRequirements { get { return new MagicAptitudeRequirement[] { new MagicAptitudeRequirement(MagieType.Vie, 7) }; } }
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckBSequence(m))
            {
                ...
                int toHeal = (int)(Caster.Skills[SkillName.EvalInt].Value * 0.4);
