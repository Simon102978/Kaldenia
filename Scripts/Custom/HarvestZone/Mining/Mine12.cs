...
{
    public class Mine12 : HarvestZone
    {
        public static void Initialize()
        {
            HarvestZone.AddZone(new Mine12());
        }
            ...
            : base(ZoneType.Mining)
        {
            ...
            //            Map = Map.Trammel;
                          ...
                          Area.Add(new Rectangle3D(new Point3D(2635, 1693, 0), new Point3D(2717, 1690, 0)));
            ...
            Veins = new HarvestVein[]
				...
				//	new HarvestVein( 20.0, 0.0, Resources[5], Resources[0]), // GoldOre - 85
					new HarvestVein( 60.0, 0.0, Resources[6], Resources[0]), // AgapiteOre 90
