...
namespace Server.Gumps
{
    ...
    public class NewSpellbookGump : Gump
    {
        public static SpellBookEntry[] m_SpellBookEntry = new SpellBookEntry[]
        {
			...
			new SpellBookEntry( 1, MagieType.Cycle,"Familier", new Type[] {typeof(BatWing), typeof(GraveDust), typeof(DaemonBlood) },0x151, 3,794),
			new SpellBookEntry( 2, MagieType.Cycle,"Peau de mort", new Type[] {typeof(BatWing), typeof(GraveDust) },0x167, 2,795),
			new SpellBookEntry( 3, MagieType.Cycle,"Fureur naturelle", new Type[] { },23005, 2,792),
			new SpellBookEntry( 4, MagieType.Cycle,"Enchanter", new Type[] {typeof(SpidersSilk), typeof(MandrakeRoot), typeof(SulfurousAsh) },24003, 2,796),
			...
			new SpellBookEntry( 8, MagieType.Cycle,"Réanimation", new Type[] {typeof(GraveDust), typeof(DaemonBlood) },0x147, 4,800),
			new SpellBookEntry( 9, MagieType.Cycle,"Faucheuse", new Type[] { },23008, 2,793),
			new SpellBookEntry( 10, MagieType.Cycle,"Créatures", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot), typeof(SpidersSilk) },0x8e7, 5,801),
			...
			new SpellBookEntry( 16, MagieType.Cycle,"Séisme", new Type[] {typeof(Bloodmoss), typeof(Ginseng), typeof(MandrakeRoot) },0x13d, 8,807),
			
			new SpellBookEntry( 1, MagieType.Mort,"Calamite", new Type[] {typeof(PigIron) },0x5003, 1,809),
			new SpellBookEntry( 2, MagieType.Mort,"Mauvais présage", new Type[] {typeof(BatWing), typeof(NoxCrystal) },0x161, 2,810),
			...
			new SpellBookEntry( 12, MagieType.Mort,"Jet de poison", new Type[] {typeof(NoxCrystal) },0x137, 5,819),
			...
			new SpellBookEntry( 1, MagieType.Obeissance,"Supprimer la malé.", new Type[] { },20744, 1,824),
			...
			new SpellBookEntry( 6, MagieType.Obeissance,"Net. par le feu", new Type[] { },20736, 1,829),
