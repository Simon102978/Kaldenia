...
namespace Server.Spells.Fifth
{
    public class PoisonFieldSpell : MagerySpell
    {
		...
		public override MagicAptitudeRequirement[] AffinityRequirements { get { return new MagicAptitudeRequirement[] { new MagicAptitudeRequirement(MagieType.Mort, 9) }; } }
        ...
        public class InternalItem : Item
        {
            ...
            public void ApplyPoisonTo(Mobile m)
            {
                ...
                int total = (m_Caster.Skills.Magery.Fixed + m_Caster.Skills.EvalInt.Fixed) / 2;
